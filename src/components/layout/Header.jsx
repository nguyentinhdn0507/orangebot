...
const Header = ({ textHeader }) => {
  ...
  return (
    <header className=" w-full h-[72px] bg-white shadow-md px-10 flex items-center justify-between">
      ...
      <div className="flex items-center gap-x-4">
        ...
        <div className="flex items-center justify-end">
          <input
            type="text"
            placeholder="テナント①"
            className="placeholder-slate-900 font-normal relative border focus:outline-none  rounded-lg px-4 py-2 cursor-pointer "
          />
