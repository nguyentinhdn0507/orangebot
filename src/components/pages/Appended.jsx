...
const Appended = () => {
  ...
  useEffect(() => {
    fetch("https://627126c26a36d4d62c2221f9.mockapi.io/tinh/fakeData")
    ...
    <div className="px-10 ">
      <div className="flex gap-x-5">
        <div className="grid grid-cols-4 w-full gap-x-5">
          <div
            className="total_file max-w-[200px] w-full bg-white py-4  rounded-lg flex 
        items-center justify-around"
          ...
          <div
            className="total_img max-w-[200px] w-full bg-white rounded-lg flex 
        items-center justify-around"
          >
            <span>
              <svg
          ...
          <div
            className="total_videos max-w-[200px] w-full bg-white  rounded-lg flex 
        items-center justify-around "
          >
            <svg
              width="60"
          ...
          <div
            className="total_docs max-w-[200px] w-full bg-white  rounded-lg flex 
        items-center justify-around "
          >
            <svg
              width="60"
        ...
        <div className="total_database max-w-[300px] w-full bg-white rounded-lg ">
          ...
          <tbody>
            ...
            {data.map((item) => (
              <tr>
                ...
                <td
                  scope="row"
                  className=" font-medium dark:text-white whitespace-nowrap py-4"
                >
                ...
                <td className="py-4">{item.capacity} MB</td>
                <td className=" py-4">
